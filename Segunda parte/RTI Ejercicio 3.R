...
#EVaR = valor absoluto (variacion tasas*DurGap)
...
#suponiendo que el i_A para los variables es i_A=tasa_referencia + spread_activo #siiii lo hice asi y me da!!!
...
#El Gap marginal indica cuanto tendra considerabdi que todos los Gaps anteriores se cerraron.
