...
RtaC=paste("Por lo tanto en el momento inicial para construir una cartera delta-neutral se deben comprar",Posicion_0_c,"acciones. 
           Las operaciones realizadas son las siguientes: se calcula el delta el cual nos da un valor de",delta_0_c,"con este mas la cantidad de acciones que forman parte de la opcion de compra vendida se calcula
            la cantidad de acciones,que se deben comprar para que la cartera sea delta-neutral. Luego, la cartera queda de la siguiente forma: La venta del call, las",Posicion_0_c,"acciones compradas, el dinero
...
RtaD=paste("Primero se calcula el d1 correspondiente a el nuevo precio de la accion (S1) 
           ...
           para que la cartera sea delta neutral. Se venden las acciones que se tienen de más 
